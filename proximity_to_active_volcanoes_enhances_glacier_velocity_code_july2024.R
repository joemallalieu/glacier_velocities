#### OUTSTANDING THINGS TO UPDATE
# Add full paper citation
# Add UKPDC DOI
# Delete file path under '#Import data' subheading (only included to show which dataset is used for these results)
...
# Statistical analyses for Mallalieu et al. 2024 "Proximity to active volcanoes enhances glacier velocity"
...
# The data for these analyses can be downloaded (in .csv format) from the UK Polar Data Centre: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
# If you use this code or the associated data please cite Mallalieu et al. 2024 using the reference above
...
# To comply with the terms of the UK Polar Data Centre, several variables in this code had units...
# ...appended to their names in brackets () in the .csv file. In order to repeat the analysis using...
# ...this code you will need to delete the units (including brackets and preceding space) from...
# ...the variable names in the .csv file hosted at the UK Polar Data Centre.
...
# Import data
volcglacdata <- read.csv(file = "F:\\a_RES_POSTDOC\\4_wip\\volc_nonvolc_velocity_comp\\3_manuscript\\submission_harddrive_copy\\Data archive\\proximity_to_active_volcanoes_enhances_glacier_velocity_data_revised.csv")
View(volcglacdata)
